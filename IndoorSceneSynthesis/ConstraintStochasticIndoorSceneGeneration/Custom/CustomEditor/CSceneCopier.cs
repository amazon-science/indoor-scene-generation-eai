...
public class CSceneCopier : Editor {
    ...
    private void DeleteHelperTools() {
        DirectoryInfo sceneDir = new DirectoryInfo("Assets/Custom/BuildTrainingBedrooms4");
    ...
    public void TakeScreenShotbyOneClick(string scenesAtPath = "Assets/Custom/BuildScenes/") {
        //destroy objs
        ...
        IEnumerator TakeAllSceneShots() {
            ...
            foreach (FileInfo sceneFile in sceneFileList) {
                ...
                //if (!sceneFile.ToString().Contains("_physics")) {
                //    continue;
                //}
    ...
    public void TakeScreenShot(FileInfo sceneFile, float height = 0.8f) {
    ...
    public void ReNameScenes() {
        /*
         Get all the screenshots from 45 degree top view for ai2thor scene
         */
        DirectoryInfo sceneDir = new DirectoryInfo("Assets/Custom/BuildTrainingKitchens1/");
        FileInfo[] sceneList = sceneDir.GetFiles("*.unity");
        ...
        foreach (FileInfo sceneFile in sceneList) {
            ...
            var newSceneName = "FloorPlan" + currentSceneName + "_physics";
            //new scene
            string saveSceneFolder = "Assets/Custom/CustomSet1/";
            string saveScenePath = saveSceneFolder + newSceneName + ".unity";
