...
{
    //task CDF json file
    public static string jsonPath = "Assets/Custom/Json/sample1.json";//"/Users/zhayizho/Downloads/task_1 (1).json";
    ...
    //global flag
    public static CRoomType samplingRoomType = CRoomType.Kitchen;
